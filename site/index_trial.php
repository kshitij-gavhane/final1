 ...
 document.getElementsByTagName('head')[0].appendChild(s);
                                    ...
                                    <div class="chatbox__support">
                                        <div class="chatbox__header">
                                            ...
                                            <div class="chatbox__content--header">
                                                ...
                                                <button class="chatbox__minimize--header minimize__button">-</button>
                                            </div>
                                        </div>
                                ...
                                <script>
                                    window.addEventListener('load', function() {
                                        setTimeout(function() {
                                            document.querySelector('.chatbox__button button').click();
                                        }, 2000); // Adjust the time delay as needed
                                    });

                                    document.querySelector('.chatbox__minimize--header').addEventListener('click', function() {
                                        document.querySelector('.chatbox__messages').classList.toggle('chatbox__messages--minimized');
                                    });
                                    window.onload = function() {
                                        var chatbox = document.querySelector('.chatbox');
                                        var intervalId = setInterval(function() {
                                            chatbox.classList.toggle('blink');
                                        }, 500);
                                    };
                                </script>
                                                    ...
                                                    <div class="tp-banner" style="display:none; max-height:500px; height:500px;">
                                                        <ul>
                                                            <li data-target="_self" data-transition="fade" data-masterspeed="1500" data-slotamount="7">
                                                                <!-- <img src="/site/assets/writereaddata/" alt="Technology" /> -->
                                                                <img src="../modules/writereaddata/files/slider1.jpg" alt="Technology" />
                                                            </li>
                                                            <li data-target="_self" data-transition="fade" data-masterspeed="1500" data-slotamount="7">
                                                                <img src="../modules/writereaddata/files/slider2.jpg" alt="Technology2" />
                                                            </li>
                                                            <li data-target="_self" data-transition="fade" data-masterspeed="1500" data-slotamount="7">
                                                                <img src="../modules/writereaddata/files/slider3.jpg" alt="Technology3" />
                                                            </li>
                                                            <li data-target="_self" data-transition="fade" data-masterspeed="1500" data-slotamount="7">
                                                                <img src="../modules/writereaddata/files/slider4.jpg" alt="Internet" />
                                                            </li>
                                                            <li data-target="_self" data-transition="fade" data-masterspeed="1500" data-slotamount="7">
                                                                <img src="../modules/writereaddata/files/Banner-4.png" alt="Aatmnirbhr" />
                                                            </li>
                                                            <!-- <li data-target="_self" data-transition="fade" data-masterspeed="1500" data-slotamount="7"> -->
	...
	<img src="../modules/writereaddata/files/Old-DI-Website-Banner-1.jpg" alt="rajeev chndraskhr"/></li>-->
                                                        </ul>
                                        ...
                                        <div id="block-bean-we-make-it-with-love-index" class="block block-bean">
                                            <div class="content">
                                                        ...
                                                        <div class="field field-name-field-bean-body field-type-text-long field-label-hidden">
                                                            <div class="field-items">
                                                                <div class="field-item even">
                                                                    <div style='padding-top: 0px; padding-bottom: 0px; background-image: url("https://digitalindia.gov.in/writereaddata/files/bg2_0_0.jpg");'>
                                                                        <div id="block-views-blog-break-news" class="block block-views">
                                                                            <div class="content">
                                                                                        ...
                                                                                        <div class="break-news shape">
                                                                                            ...
                                                                                            <div class="break-news-slider">
                                                                                                <div class="views-row views-row-1 views-row-odd views-row-first">
                                                                                                    ...
                                                                                                    <a href="#" target="_blank"> आपत्कालीन परिस्थितीकरिता झोननिहाय २४ तास कार्यरत नियंत्रण कक्ष</a>
                                                                                                </div>
                                                                                                <div class="views-row views-row-2 views-row-even">

                                                                                                    <a href="#" target="_blank"> नागपूर महानगरपालिका सार्वत्रिक निवडणूक २०२२</a>
                                                                                                </div>
                                                                                                <div class="views-row views-row-3 views-row-odd">

                                                                                                    <a href="#" target="_blank">समाज कल्याण विभागामार्फतदिव्यांग योजने करीता लिंक . </a>
                                                                                                </div>
                                        ...
                                        <div class="panel-separator"></div>
                                        <div id="block-bean-template-feature-index" class="block block-bean">
                                            <div class="content">
                                                                            ...
                                                                            <div class='row'>
                                                                                <div class='fx feature-img wow fadeInUp col-md-3' data-wow-delay='200ms' data-wow-duration='500ms'>
                                                                                    ...
                                                                                    <div class="feature-details-hidden">
                                                                                        <h5 class="bold feature-head main-color">All Announcements</h5> <a class="cws-button btn btn-md shape btn-turquoise with-icon new-angle" href="#">View All</a>
                                                                                    </div>
                                                                                </div>
                                                                                <div class='fx feature-img wow fadeInUp col-md-3' data-wow-delay='400ms' data-wow-duration='500ms'>
                                                                                    <div class='newstrackfront-title-length'>
                                                                                        <div class="view view-portfolio-grid view-id-portfolio_grid view-display-id-page_2 view-dom-id-7a65322e4df90233b7d4e45035fc37c8">
                                                                                ...
                                                                                <div class='fx feature-img wow fadeInUp col-md-3' data-wow-delay='600ms' data-wow-duration='500ms'>
                                                                                    <div class='newstrackfront-title-length'>
                                                                                        <div class="view view-portfolio-grid view-id-portfolio_grid view-display-id-page_3 view-dom-id-f8136b4f715f427f24675bcbf66489eb">
                                                                                ...
                                                                                <div class='fx feature-img wow fadeInUp col-md-3' data-wow-delay='800ms' data-wow-duration='500ms'>
                                                                                    <div class='newstrackfront-title-length'>
                                                                                        <div class="view view-portfolio-grid view-id-portfolio_grid view-display-id-page_4 view-dom-id-f8f248cfb32df609366c2d7072c23e54">
                                        ...
                                        <div class="panel-separator"></div>
                                        <div id="block-bean-testimonials-index" class="block block-bean">
                                            <div class="content">
                                                <div class="entity entity-bean bean-shortcode clearfix" about="/block/testimonials---index" typeof="">
                                                    ...
                                                    <div class="content">
                                                        <div class="field field-name-field-bean-body field-type-text-long field-label-hidden">
                                                            <div class="field-items">
                                                                <div class="field-item even">
                                                                    <div class='section parallax' style='background-image: url("../site/img/announce_backg.png");'>
                                                                        <!--<div class="heading full-heading alter-gry" style="background-image:url('writereaddata/files/bg2_0.jpg')">-->
                                                                        <div class="heading full-heading alter-gry" style="background-color:#fff;">
                                                                            <h3 class="inner-head">Testi<span class="main-color heavy-font">monials</span></h3> <!--<h5 class="small-heading"><span class="main-color">Checkout </span>our features</h5>	-->
                                                                        </div>
                                                                        <div class='container'>
                                        ...
                                        <div class="panel-separator"></div>
                                        <div id="block-bean-logo-partner-slick-index" class="block block-bean">
                                            <div class="content">
