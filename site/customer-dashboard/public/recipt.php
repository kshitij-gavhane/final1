          <?php
            ...
            ?>
              ...
              <head>
                  <meta charset="UTF-8">
                  <title>Payment Receipt - Invoice #<?php echo $payment['invoice']; ?></title>
                  <style>
                      @page {
                          size: 9.5in 12in;
                      }
                  ...
                  <table style="table-layout: fixed; width: 100%; padding: 8px; ">
                      <tbody>
                          <tr>
                              ...
                              <td>
                                  <img src="./invoice/images/images-favicon.png" alt="nmc-logo" width="100px">
                              </td>
                  ...
                  <table style="table-layout: fixed; width: 100%; padding: 5px; ">
                      <tbody>
                          <tr>
                              ...
                              <td class="text-center" style="color: brown;">Inv #<?php echo $payment['invoice']; ?></td>
                  ...
                  <div style="padding-top:10px; padding-bottom:2px;">
                      <table style="table-layout: fixed; width: 100%; padding: 5px; ">
                          <tbody>
                              <tr>
                                  <img>
                                  <img src="./invoice/images/signature.png" style="height:60px;"></img>
                                  <div>
          ...
          <?php
                ...
                // If no payment record is found, display an error message
