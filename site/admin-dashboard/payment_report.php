						...
						<div class="row">
							<table class="table table-bordered">
								...
								<tbody>
									...
									$payments = $conn->query("Select p.date_created,p.tenant_id ,concat(t.lastname,', ',t.firstname,' ',t.middlename) as name,p.invoice,p.amount from payments p,tenants t where p.aadhar=t.aadhar order by p.date_created");
