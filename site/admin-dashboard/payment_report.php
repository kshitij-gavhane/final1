						...
						<div class="row">
							<table class="table table-bordered">
								...
								<tbody>
									...
									$i = 1;
									$tamount = 0;
									$payments = $conn->query(" SELECT p.date_created,p.tenant_id ,d.owner_name, p.invoice,p.amount from payments p,demand d where p.aadhar=d.aadhar and date_format(p.date_created,'%Y-%m') = '$month_of' order by unix_timestamp(date_created)  asc");
									...
									?>
											<tr>
												...
												<td><?php echo ucwords($row['tenant_id']) ?></td>
