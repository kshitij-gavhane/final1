					...
					<div class="card-body">
						<table class="table table-condensed table-bordered table-hover">
							...
							<tbody>
								<?php 
								$i = 1;
								$tenants =$conn->query("SELECT * FROM payments,tenants WHERE tenants.tenant_id=payments.tenant_id");
								...
								<tr>
									...
									<td class="">
										 <p> <b><?php echo $row['first_name']." ".$row['middle_name']." ".$row['last_name'] ?></b></p>
									</td>
									<td class="text-right">
