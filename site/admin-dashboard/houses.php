								...
								?>
									<tr>
										...
										<!-- <button class="btn btn-sm btn-danger delete_house" type="button" data-id="<?php echo $row['id'] ?>">Delete</button> -->
											<!-- <button class="btn btn-sm btn-primary edit_house" type="button" data-house_no="<?php echo $row['shop_count'] ?>" >Edit</button> -->
											<!-- <button class="btn btn-sm btn-danger delete_house" type="button" >Delete</button> -->
